...
async function addDesigningUser() {
    ...
    try {
        const email = 'designing@hindusthan.net';
        const password = 'hicas';
        const hashedPassword = await bcrypt.hash(password, 10);
        const role = 'designing_team';
        const fullName = 'Designing Team';
        ...
        console.log('✅ Designing Team user ready.');
