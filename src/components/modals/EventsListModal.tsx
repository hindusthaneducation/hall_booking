...
export function EventsListModal({ title, events, onClose, onSelectEvent, onUploadLink }: EventsListModalProps) {
    ...
    const getStatusBadge = (status: string) => {
        switch (status) {
            case 'completed':
                return <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-green-100 text-green-800">Uploaded</span>;
            case 'today':
