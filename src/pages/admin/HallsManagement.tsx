            ...
            {filteredHalls.map((hall) => (
              ...
              >
                <div className="aspect-video bg-gray-200 overflow-hidden">
                  <img
                    src={hall.image_url?.startsWith('http') ? hall.image_url : `${API_URL}${hall.image_url}`}
                    alt={hall.name}
          ...
          <div>
            ...
            <div className="mt-1 flex items-center space-x-4">
              <div className="flex-shrink-0 h-32 w-48 bg-gray-100 rounded-lg overflow-hidden border border-gray-200">
                {formData.image_url ? (
                  <img
                    src={formData.image_url.startsWith('http') ? formData.image_url : `${API_URL}${formData.image_url}`}
                    alt="Preview"
